...
**Commercial** Admin Dashboard coded in [Flask Framework](https://palletsprojects.com/p/flask/) on top of **Dashkit Dashboard** design (PRO Version) designed by CssNinja Agency - product generated by AppSeed.
